<?php
 ...
 $str_sql = "select * from woke where (weight < 50 ) and gender ='หญิง'";
...
<html>
 ...
 <body>
  <div>
   ...
   <div style="padding: 20px 0px 30px 0px; font-size: 20px; color:blue; margin: 0px 0px 0px 10px;">น้ำหนัก ไม่เกิน 50</div>
