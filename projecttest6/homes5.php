<?php
 ...
 $str_sql = "SELECT * FROM woke WHERE (weight BETWEEN 51 AND 90 )AND gender = 'ชาย';";
 ...
 <body>
  <div>
   <div style="float: left;">
    <div style="padding: 20px 150px 30px 20px;"><a href="add01.php" style="color: blue;">เพิ่มข้อมูล</a></div>
   ...
   <div style="padding: 20px 0px 30px 0px; font-size: 20px; color:blue; margin: 0px 0px 0px 10px;">น้ำหนัก 51-90</div>
